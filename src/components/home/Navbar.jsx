    ...
    return (
        <div className='navbar'>
            <div className="navHeading">
                <span className='companyName'><span>Do</span>easily</span>
                <p className='tagLine'>Business Made Easy</p>
            </div>

            <div className="navLinksHeading">
